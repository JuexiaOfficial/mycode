...
void PoseGraph::addKeyFrame(KeyFrame *cur_kf, bool flag_detect_loop)
{
    ...
    if (SAVE_LOOP_PATH)
    {
        ...
        ofstream foutC1("/home/qizhengxun/Desktop/ws/ros_modify_PL_VINS_ws/output/pose_graph/orchard_plvins_loop.txt", ios::app);
...
void PoseGraph::updatePath()
{
    ...
    for (it = keyframelist.begin(); it != keyframelist.end(); it++)
    {
        ...
        if (SAVE_LOOP_PATH)
        {
            ...
            ofstream foutC1("/home/qizhengxun/Desktop/ws/ros_modify_PL_VINS_ws/output/pose_graph/orchard_plvio_loop.txt", ios::app);
            foutC1.setf(ios::fixed, ios::floatfield);
            foutC1.precision(9);
